            ...
            <nav class="flex h-9 items-center justify-between" aria-label="Global">
                <div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
                    <NuxtLink to="/" class="-m-1.5 p-1.5">
                        <img class="h-6" src="https://imagedelivery.net/5zM6Rdl2uV8Hmr9WxRh20g/7ed7598b-5520-4e18-5159-daa458739b00/md" alt=""/>
                    </NuxtLink>
                </div>
                <div class="flex min-w-0 flex-1 justify-end">
                    <NuxtLink to="/" v-if="actionHome"
                              class="inline-block rounded-lg px-3 py-1.5 text-sm font-semibold leading-6 text-neutral shadow-sm ring-1 ring-accent hover:ring-accent-focus">
                        Home
                    </NuxtLink>
                    <a @click="auth.logout()" v-else-if="isAuth"
                              class="inline-block rounded-lg px-3 py-1.5 text-sm font-semibold leading-6 text-neutral shadow-sm ring-1 ring-accent hover:ring-accent-focus">
                        Logout
                    </a>
...
<script setup>
// Setup props to be passed to this component
