    ...
    <div class="mx-auto w-full max-w-md lg:w-[25rem] overflow-auto pb-1.5">
        <div class="overflow-auto lg:pr-3">
            <ul role="list" class="relative z-0 divide-y divide-gray-200 border-b border-t border-gray-200 overflow-auto">
                <li v-for="service in props.services" :key="service.name" class="relative py-3 hover:bg-gray-50 snap-center" v-if="!props.pending">
                    <div class="flex items-center justify-between space-x-4">
                        <div class="min-w-0 space-y-2">
                            ...
                            <div class="relative group flex items-center space-x-2.5 sm:hidden" v-if="service.is_up">
